...
fn update_min_max(point: &na::Point2<f64>, min: &mut na::Vector2<f64>, max: &mut na::Vector2<f64>) {
...
pub fn boundaries(
    ...
    // consider robot pose;
    update_min_max(&Point2::from(tp.translation.vector), min, max);
    ...
    for (i, range) in scan.ranges.iter().enumerate() {
        ...
        let point = na::Point2::new(r as f64, 0.);
